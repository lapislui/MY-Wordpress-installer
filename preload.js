...
contextBridge.exposeInMainWorld("desktopAPI", {
  ...
  browserContinueGoogleSignin: (url) => ipcRenderer.invoke("browser:continue-google-signin", url),
  ...
  saveGoogleOAuthConfig: (payload) => ipcRenderer.invoke("settings:save-google-oauth-config", payload),
  getGoogleOAuthStatus: () => ipcRenderer.invoke("oauth:get-google-status"),
  beginGoogleSignin: () => ipcRenderer.invoke("oauth:begin-google-signin"),
  signOutGoogle: () => ipcRenderer.invoke("oauth:signout-google"),
